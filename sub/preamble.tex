...
%:                  논문 제목과 저자 이름을 입력하시오
% ----------------------------------------------------------------------
\title{AVHRR 자료를 이용한 한반도 주변 해역의 해수면 온도 산출} %한글 제목
\engtitle{Estimation of Sea Surface Temperature around the Korean Peninsula Using AVHRR Data} %영문 제목
\korname{박 서 진} %저자 이름을 한글로 입력하시오 (글자 사이 띄어쓰기)
\engname{Park, Seo Jin} %저자 이름을 영어로 입력하시오 (family name, personal name)
\chnname{朴 敍 進} %저자 이름을 한자로 입력하시오 (글자 사이 띄어쓰기)
